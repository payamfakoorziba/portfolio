  ...
  return (
    <main className="flex flex-col w-full gap-y-20">
      ...
      <div className="absolute bg-grid-white/10 top-0 inset-x-0 bottom-1/3 -mt-20 -z-10">
        ...
        <div className="absolute inset-0 [mask-image:radial-gradient(ellipse_at_right,transparent_20%,black)] bg-[#3F3F45]" />
        <div className="absolute inset-0 [mask-image:radial-gradient(ellipse_at_left,transparent_10%,black)] bg-[#3F3F45]" />
      </div>
      {/* Spotlight effect */}
      <div className="animate-spotlight opacity-0 size-[100px] md:size-[600px] absolute bg-white/10 rounded-full -top-1/2 left-0 pointer-events-none blur-3xl" />
